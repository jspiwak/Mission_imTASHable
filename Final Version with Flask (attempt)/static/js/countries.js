var margin = {top: 50, right: 20, bottom: 150, left: 150},
...
var data = d3.json("/countriesdata", function(error, data) {
// console.log(data);
  ...
  svg.append("g")
    ...
    svg.append("text")
      ...
      .text("Number of Streams Per Country");
